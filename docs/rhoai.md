...
2) Go to the `Data Science Projects` section and access your application's project named `chatbot-bscon-demo-3`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `chatbot-bscon-demo-3-notebook`.
...
5) In the terminal, run `cd chatbot-bscon-demo-3` to navigate to your sample app's directory.
